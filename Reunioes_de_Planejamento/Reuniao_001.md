...
Participantes que desejarem fazer parte da organização do projeto podem, de acordo com sua disponibilidade, optar por participar como:
...
* DIRETRIZES: Identificar onde há necessidade de conteúdo, selecionar o que já há publicado e fazer uma curadoria.

### SETEMBRO:

* PROJETO: initPresencaOnline

* OBJETIVO: Aumentar a visibilidade do Codando Juntas por meio da estruturação e consolidação das redes sociais. "Nos encontrem e aprendam conosco".

#### FERRAMENTAS

* GITHUB: Deverá ser usado para documentar e para estruturar os projetos do Codando Juntas;

* FACEBOOK: O grupo "Mulheres aprendendo Programação" será mantido e deve aos poucos ser moldado para tornar-se um canal para compartilhamento de experiências, reflexões e esclarecimento de dúvidas;

* MEDIUM: Deverá ser um canal para promover conteúdo, review, tutoriais, etc. As participantes do projeto serão encorajadas a produzir e compartilhar conteúdo;

* YOUTUBE: Deverão ocorrer lives, inicialmente estruturadas sob a forma de uma _roda de conversa_ para debater temas pertinentes;

* LANDING PAGE: Desenvolvimento do site do Codando Juntas.
...
* Discord - Como monitorar os questionamentos?;

* O projeto de desenvolvimento da Landing Page tem como líder a Nicole e é composto pela as participantes: Flávia, Mara, Priscyla e Drielly;

* Lives no Youtube - Estruturar temas e a dinâmica. 
...
PROJETO: curriculoFest

OBJETIVO: Estruturar uma feira de orientação a respeito de currículos e divulgação de vagas de emprego.

Será feita uma reunião para estruturarmos o projeto, mas por hora temos como características iniciais:

* Ser 100% online;

* Ter como base o que foi elaborado pelo 1 Million Women to Tech (sugerido que as participantes pesquisem a respeito para a próxima reunião);

* MEDIUM: Deverá ser um canal para promover conteúdoe/ou tutoriais. As participantes do projeto serão encorajadas a produzir e compartilhar conteúdo;

* Conteúdo e Site ainda a serem definidos.
...
OBJETIVO: Proporcionar o networking (local/nacional).
...
* GRUPOS DE ESTUDOS PRESENCIAIS;

* Canal do Youtube e colaboração com o Dev Friends (Canal da Dantas);
...
* A equipe pode incluir seu vínculo com o Codando Juntas no LinkedIn;
	- EQUIPE: Pode incluir e descrever sua participação como Experiência Profissional;
	- PARTICIPANTES VOLUNTÁRIAS NA COORDENAÇÃO: Podem incluir e descrever sua participação como Trabalho Voluntário;
	- PARTICIPANTES: Podem incluir e descrever sua participação como Educação;

* Diretrizes para utilização do GitHub:
	- Nunca fazer commit dentro da Master;
	- Utilizar sempre o pull request e o code review;
	- Sempre que possível as participantes são incentivadas a fazer a revisão do conteúdo inserido.

COLABORAÇÃO: Drielly Carvalho
